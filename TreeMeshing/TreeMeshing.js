...
function mainTreeMeshing()
{
    ...
    var Param_Slice_Step = result.InputTbl[0];
    var Param_Slice_Depth = result.InputTbl[1];
    ...
    // adding bottom
    var bottomRes = SPoly.ConstraintMesh2D(0,[allMultis[0]],ZVect,0,0);
    ...
    // adding top
    var topRes = SPoly.ConstraintMesh2D(0,[allMultis[allMultis.length-1]],ZVect,0,0);
